...
class AuthenticationInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.events.cloud.audit.v1.ServiceAccountDelegationInfo service_account_delegation_info = 6;</code>
     */
     ...
     *           This is a scheme-less URI full resource name. For example:
     *           "//iam.googleapis.com/projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}/keys/{key}"
     *     @type \Google\Events\Cloud\Audit\V1\ServiceAccountDelegationInfo[]|\Google\Protobuf\Internal\RepeatedField $service_account_delegation_info
     *           Identity delegation history of an authenticated service account that makes
     *           the request. It contains information on the real authorities that try to
     *           access GCP resources by delegating on a service account. When multiple
     *           authorities present, they are guaranteed to be sorted based on the original
     ...
     *
     * Generated from protobuf field <code>repeated .google.events.cloud.audit.v1.ServiceAccountDelegationInfo service_account_delegation_info = 6;</code>
     * @param \Google\Events\Cloud\Audit\V1\ServiceAccountDelegationInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setServiceAccountDelegationInfo($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Events\Cloud\Audit\V1\ServiceAccountDelegationInfo::class);
