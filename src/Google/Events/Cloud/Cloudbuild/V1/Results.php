 ...
 *
 * Generated from protobuf message <code>google.events.cloud.cloudbuild.v1.Results</code>
 */
class Results extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.events.cloud.cloudbuild.v1.BuiltImage images = 2;</code>
     */
    private $images;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.events.cloud.cloudbuild.v1.TimeSpan artifact_timing = 7;</code>
     */
     ...
     *
     *     @type \Google\Events\Cloud\Cloudbuild\V1\BuiltImage[]|\Google\Protobuf\Internal\RepeatedField $images
     *           Container images that were built as a part of the build.
     ...
     *           can produce this output by writing to `$BUILDER_OUTPUT/output`.
     *           Only the first 4KB of data is stored.
     *     @type \Google\Events\Cloud\Cloudbuild\V1\TimeSpan $artifact_timing
     *           Time to push all non-container artifacts.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.events.cloud.cloudbuild.v1.BuiltImage images = 2;</code>
     * @param \Google\Events\Cloud\Cloudbuild\V1\BuiltImage[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setImages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Events\Cloud\Cloudbuild\V1\BuiltImage::class);
        $this->images = $arr;
