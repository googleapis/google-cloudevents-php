 ...
 *
 * Protobuf type <code>google.events.cloud.cloudbuild.v1.BuildOptions.SubstitutionOption</code>
 */
...
class_alias(SubstitutionOption::class, \Google\Events\Cloud\Cloudbuild\V1\BuildOptions_SubstitutionOption::class);
