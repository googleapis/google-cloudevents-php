 ...
 *
 * Protobuf type <code>google.events.cloud.cloudbuild.v1.BuildOptions.VerifyOption</code>
 */
class VerifyOption
{
    /**
...
class_alias(VerifyOption::class, \Google\Events\Cloud\Cloudbuild\V1\BuildOptions_VerifyOption::class);
