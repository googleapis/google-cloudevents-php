 ...
 *
 * Protobuf type <code>google.events.cloud.cloudbuild.v1.BuildOptions.LogStreamingOption</code>
 */
...
class_alias(LogStreamingOption::class, \Google\Events\Cloud\Cloudbuild\V1\BuildOptions_LogStreamingOption::class);
